# - modulo necessário para realizar as operações de CRUD no mysql.
...
# - Coenxão com o mySQL.
vHost = input('insira o host: ')			# localhost
vUser = input('insira o user: ')			# crud
vPass = input('insira a senha: ')			# crud
vDB   = input('insira o nome do banco: ')	# empresa

# - Realiza a conexão com o mysql.
conexao = mysql.connector.connect(
	host     = vHost.lower(),
	user 	 = vUser.lower(),
	password = vPass.lower(),
	database = vDB.lower())
